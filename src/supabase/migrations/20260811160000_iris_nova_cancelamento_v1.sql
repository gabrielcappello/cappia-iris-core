-- Iris Nova - cancelamento de agendamento pelo paciente (banco DEV,
-- bcmuqautblvjdqzhjfbw).
--
-- Projeto-alvo: bcmuqautblvjdqzhjfbw. Migration irma para o banco operacional
-- em src/supabase/migrations-legado/ -- ver o bloco "PARIDADE".
--
...
-- O CORPO DA FUNCAO E IDENTICO ao da migration irma (operacional), e desta
...
-- `agendamentos_status_valido` JA ADMITE 'cancelado' nos dois bancos:
...
--      and conname='agendamentos_status_valido';       -- deve conter 'cancelado'
